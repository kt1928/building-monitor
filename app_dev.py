...
tab1, tab2, tab3 = st.tabs(["🔍 Simple ZIP Search", "🧐 Smart Address Search", "🧪 Reserved/Custom"])

# KEEP TAB 1 UNCHANGED
# --- Tab 1 ---
# --- Tab 1 ---
# (Existing tab1 code is unchanged and not shown for brevity)
        ...
        if not zip_input or not zip_input.isdigit():
            ...
            try:
                ...
                if not listings:
                    ...
                    st.bar_chart(df_display[["Price Sold"]].rename(columns={"Price Sold": "Sale Price"}))
